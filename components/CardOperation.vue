            ...
            <v-expansion-panel-text>
                ...
                <v-tabs-window v-model="tab" mobile>
                    <v-tabs-window-item value="one">
                        ...
                        <v-carousel :continuous="false" :show-arrows="false" color="#033" height="120"
                            hide-delimiter-background>
                            <v-carousel-item v-for="(theme, i) in themeList" :key="i" cover>
                                <div class="d-flex flex-row ga-2 align-center justify-start flex-wrap">
                                    <div v-for="(item,key) in theme" class="color-item rounded-circle cursor-pointer"
                                    :class="{key==selectedColor}"
                                        :style="item.bgcolor" @click="changeColor(item)">
                                    </div>
                                </div>
                            </v-carousel-item>
                        </v-carousel>
                    ...
                    <v-tabs-window-item value="four">
                        <div class="d-flex flex-row align-center ga-2 justify-start px-2">
                            ...
                            <div>
                                ...
                                <div class="d-flex">
                                    <v-slider v-model="fontSizeSlider" thumb-label :step="0.1" track-color="grey"
                                        min="0.7" max="1.5" @update:modelValue="onSliderChange('fontsize')">
                                        <!-- <template v-slot:prepend>
                                                    <v-btn icon="mdi-minus" size="small" variant="text"
