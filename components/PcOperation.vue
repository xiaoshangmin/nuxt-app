<template>
  <figure>
    ...
    <v-tabs v-model="tab" align-tabs="center" center-active>
      ...
      <v-tab value="setting" class="text-none">设置</v-tab>
    </v-tabs>

    <v-tabs-window v-model="tab">
      <v-tabs-window-item value="template">
        <div class="d-flex flex-wrap justify-space-between align-center template py-4 px-2">
      ...
      <v-tabs-window-item value="setting">
        <div class="py-2 px-2" v-show="'temp-3' == userConfig.tempId">
          <v-text-field clearable variant="outlined" placeholder="请输入url地址" v-model="url"></v-text-field>
        </div>

        <div class="d-flex flex-wrap align-center justify-start py-2 px-2">
...
<template v-slot:append>
        ...
        <div class="d-flex flex-row align-center justify-start  py-2 px-2">
          ...
          <div>
            <v-btn-toggle v-model="widthSlider" color="deep-purple-accent-3" rounded="0" @click="onBtnToggle('width')">
        ...
        <div class="d-flex align-center justify-start py-2 px-2">
          <div class="d-flex flex-row align-center">
            <div style="width: 4rem">
              {{ $t("Font") }}
            </div>
